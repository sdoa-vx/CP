...
(function () {
    ...
    const MANIFEST = {
        ...
        docs: { description: "Undeclared duplicate of the canonical PartnerTicker.v3.ui module (also present in adapters/ and components/); pending consolidation in Phase 4. Local model activity ticker. Minimized strip -> hover preview -> locked panel. Replays orchestrator events from each completed request." },
            author: "ProtoAI team",
        actions: {
            commands: {
