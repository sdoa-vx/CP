...
(function () {
    "use strict";
    const MANIFEST = { id: "EmptyState.prim", type: "primitive", layer: 2, runtime: "Browser", version: "4.0.1", requires: [], dependencies: [], capabilities: ["emptystate:create"], dataFiles: [], lifecycle: [], actions: { commands: { create: {} }, events: {}, accepts: {}, slots: {} }, backendDeps: [], docs: { description: "Empty state placeholder with icon, title, hint, and action.", author: "ProtoAI team", sdoa: "4.0.0" }, last_modified: "2026-07-13T00:00:00Z" };
