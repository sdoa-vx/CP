...
class SleeveBase {
  static MANIFEST = {
    ...
    docs: {
      description: "Exceeds the 500-line Layer 3 hard cap (abstract base class for all SDOA v5.5 Sleeve sovereigns — lifecycle contract, transport negotiation, sandboxing, LoRA training pipeline, telemetry). Flagged for the oversized-file split scheduled in a later remediation phase; not fixed here."
    }
  };
