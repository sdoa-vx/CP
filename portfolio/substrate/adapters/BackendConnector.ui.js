...
(function () {
    ...
    class BackendConnector {
        ...
        _init() {
            ...
            this._initEventStreamListeners();
        }

        async _initEventStreamListeners() {
            if (!window.__TAURI__?.event?.listen) return;

            // Forward these backend orchestrator events to the frontend EventBus
        ...
        async invokeTauri(workflow, payload) {
            ...
            const mapping = {
                ...
                "settings_test_key":    "settings_test_key"
            };
            ...
            const nativeCommands = [
                "get_status", "get_launch_flags", "engine_status",
                "settings_get", "settings_set", "settings_test_key",
                "settings_first_run_status", "settings_complete_first_run",
                "engine_reconnect",
                "get_project_dir",
                "fs_read_file", "fs_write_file", "fs_list_dir",
                "fs_rename", "fs_copy", "fs_unlink", "fs_remove", "fs_mkdir", "fs_stat",
                "run_workflow"
            ];
