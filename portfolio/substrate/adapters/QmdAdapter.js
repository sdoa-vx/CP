...
// Changes: Relocated to canonical sdoavx/substrate/adapters/ structure
// ──────────────────────────────────────────────────────────────────
...
function findQmdEntry() {
    ...
    const candidates = [
        ...
        // Strategy 2: substrate root
        path.join(adapterDir, "node_modules/@tobilu/qmd/dist/cli/qmd.js"),
    ...
    throw new Error(
        "qmd module not found. Make sure @tobilu/qmd is installed in node_modules."
    );
}
