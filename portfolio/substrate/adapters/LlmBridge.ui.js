...
(function () {
    ...
    class LlmBridge {
        ...
        static MANIFEST = {
            ...
            docs: {
                description: "Undeclared duplicate of the LlmBridge UI adapter — copies of this module exist across substrate/adapters, substrate/services, and elsewhere in the repo. Flagged for consolidation in a later remediation phase; not fixed here."
            }
        };
