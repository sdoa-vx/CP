...
exports.TokenBudgetAdapter = void 0;
...
class TokenBudgetAdapter {
    lookupContextLimit(model) {
        ...
        for (const [prefix, limit] of Object.entries(MODEL_CONTEXT_LIMITS)) {
            if (m.includes(prefix.toLowerCase()))
                return limit;
        }
        return 131072;
    }
    ...
    trimToFit(systemPrompt, message, model, maxOutputTokens = 4096) {
...
exports.TokenBudgetAdapter = TokenBudgetAdapter;
TokenBudgetAdapter.MANIFEST = {
