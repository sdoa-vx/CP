// ──────────────────────────────────────────────────────────────────
// File:    GoogleDrive.workflow.js
// Version: 5.0.0
// Updated: 2026-06-17T00:00:00Z
// Changes: Relocated to canonical sdoavx/ structure; FIXED broken require paths:
//          require("../services/WorkflowBase") → require("./WorkflowBase")
//          require("../services/WorkflowResult") → require("./WorkflowResult")
//          require("../../access/env/paths") → require("../access/env/paths")
// ──────────────────────────────────────────────────────────────────
// Last modified: 2026-06-03 04:55 UTC
// ============================================================
// GoogleDrive.workflow.js — SDOA v5.0 Workflow (NodeJS)
// version: 5.0.0
// ============================================================
...
class GoogleDriveWorkflow extends WorkflowBase {
    static MANIFEST = {
        ...
        docs: {
            description: "Handles Google Drive OAuth, file listing, and download operations.",
            author: "ProtoAI team",
            sdoa: "5.0.0"
        }
    };
