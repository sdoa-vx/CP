    ...
    try {
      ...
      if (data.topic === 'backlog' && Array.isArray(data.payload?.events)) {
        ...
        if (data.type === 'scan:progress' && data.payload) {
             ...
             const topbarScanFile = document.getElementById('topbarScanFile');
             const topbarScanFileName = document.getElementById('topbarScanFileName');
             ...
             if (topbarScanFile && topbarScanFileName) {
                 topbarScanFile.style.display = 'block';
                 topbarScanFileName.textContent = data.payload.currentFile || '...';
             }
          ...
          if (data.type === 'scan:complete') {
             ...
             const topbarScanFile = document.getElementById('topbarScanFile');
             if (topbarScanFile) topbarScanFile.style.display = 'none';
          }
